...
namespace WoAutoCollectionPlugin.PingTrackers
{
    ...
    public class PacketPingTracker : PingTracker
    {
        ...
        public PacketPingTracker(GameAddressDetector addressDetector, GameNetwork network) : base(addressDetector, PingTrackerKind.Packets)
        {
        ...
        public static void UpdatePing(PingStatsPayload payload)
        {
            PluginLog.LogDebug($"Packet ping: LastRTT {payload.LastRTT} ms, AverageRTT: {payload.AverageRTT}ms");
        }
