...
namespace WoAutoCollectionPlugin.Craft
{
    public unsafe class AutoCraft : IDisposable
    {
        ...
        {
            if (WoAutoCollectionPlugin.Debug) PluginLog.Verbose($"Step Change: {e}");
            if (e == 0)
            {
        ...
        {
            if (WoAutoCollectionPlugin.Debug) PluginLog.Verbose($"Condition_ConditionChange: {flag}");
        ...
        {
            if (WoAutoCollectionPlugin.Debug) PluginLog.Verbose("ScanForHQItems Test");
