    ...
    public static class CommonUi
    {
        ...
        public static unsafe (int, string) GetGatheringIndex(List<string> ItemNames) {
            ...
            if (ptr != IntPtr.Zero)
            {
                ...
                string n8 = "";
                if (itemId1 != 0) {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId1, out var item1);
                    n1 = item1 != null ? item1.Name.ToString() : "";
                }
                if (itemId2 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId2, out var item2);
                    n2 = item2 != null ? item2.Name.ToString() : "";
                }
                if (itemId3 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId3, out var item3);
                    n3 = item3 != null ? item3.Name.ToString() : "";
                }
                if (itemId4 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId4, out var item4);
                    n4 = item4 != null ? item4.Name.ToString() : "";
                }
                if (itemId5 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId5, out var item5);
                    n5 = item5 != null ? item5.Name.ToString() : "";
                }
                if (itemId6 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId6, out var item6);
                    n6 = item6 != null ? item6.Name.ToString() : "";
                }
                if (itemId7 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId7, out var item7);
                    n7 = item7 != null ? item7.Name.ToString() : "";
                }
                if (itemId8 != 0)
                {
                    AlphaProject.GameData.Gatherables.TryGetValue(itemId8, out var item8);
        ...
        public static unsafe bool HasStatus(string statusName)
        {
            ...
            while (statusList.MoveNext())
            {
                ...
                if (AlphaProject.GameData.Status.TryGetValue(statusId, out var state)) {
