...
namespace AlphaProject
{
    public static unsafe class Util
    {
        ...
        public static Dictionary<string, List<string>> CommandParams = new() {
            { Tasks.Daily, new() { "duration", "level", "bagLimit", "otherTask", "repair", "extractMateria" } },
            { Tasks.GCraft, new() { "pressKey", "type", "recipeName", "hq", "exchangeItem", "repair", "extractMateria" } },
            { Tasks.CFish, new() { "ftype", "fexchangeItem"} },
            { Tasks.SpearFish, new() { "ftype" } }
        };
