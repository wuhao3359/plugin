...
namespace AlphaProject.SeFunctions
{
    public struct FishRecord
    {
        ...
        //{
        //    get => HasSpot ? AlphaProject.GameData.FishingSpots.TryGetValue(_fishingSpot, out var s) ? s : null : null;
        ...
        //{
        //    get => HasBait
        //        ? AlphaProject.GameData.Bait.TryGetValue(_bait, out var b) ? b :
        //        AlphaProject.GameData.Fishes.TryGetValue(_bait, out var f) ? new Bait(f.ItemData) : Bait.Unknown
        //        : Bait.Unknown;
        //    set => _bait = value.Id;
        //}
        ...
        //public Fish? Catch
        //{
        //    get => HasCatch ? AlphaProject.GameData.Fishes.TryGetValue(_catch, out var f) ? f : null : null;
        ...
        //{
        //    var ts = TimeStamp;
        //    if (ts < TimeStamp.Epoch || ts > AlphaProject.Time.ServerTime)
        //        return false;
        ...
        //     || TimeStamp > AlphaProject.Time.ServerTime
