...
public static unsafe class GenericHelpers
{
    ...
    {
        return DalamudApi.Condition[ConditionFlag.Occupied] || DalamudApi.Condition[ConditionFlag.Occupied30] || DalamudApi.Condition[ConditionFlag.Occupied33] || DalamudApi.Condition[ConditionFlag.Occupied38] || DalamudApi.Condition[ConditionFlag.Occupied39] || DalamudApi.Condition[ConditionFlag.OccupiedInCutSceneEvent] || DalamudApi.Condition[ConditionFlag.OccupiedInEvent] || DalamudApi.Condition[ConditionFlag.OccupiedInQuestEvent] || DalamudApi.Condition[ConditionFlag.OccupiedSummoningBell] || DalamudApi.Condition[ConditionFlag.WatchingCutscene] || DalamudApi.Condition[ConditionFlag.WatchingCutscene78] || DalamudApi.Condition[ConditionFlag.BetweenAreas] || DalamudApi.Condition[ConditionFlag.BetweenAreas51] || DalamudApi.Condition[ConditionFlag.InThatPosition];
    }
    ...
    {
        var t = DalamudApi.DataManager.GetExcelSheet<TerritoryType>().GetRow(terr);
    ...
    public static void ShellStart(string s)
    {
        ...
        {
            PluginLog.Error($"Could not open {s.Cut(60)}\n{e}");
        });
    }
